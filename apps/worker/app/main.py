...
header{margin-bottom:28px}h1{font-size:36px;margin:0 0 8px}p{color:#aab4d0}
.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:14px}
.card{background:#151c31;border:1px solid #29324d;border-radius:16px;padding:22px}
.card b{display:block;font-size:18px;margin-bottom:8px}.status{color:#66e3a4}
code{background:#0f1528;padding:3px 7px;border-radius:6px}
</style></head>
<body><main>
<header><h1>CaseHunter AI</h1><p>منصة اكتشاف وتحليل وتجهيز المحتوى بالذكاء الاصطناعي</p></header>
<div class="grid">
<div class="card"><b>🔎 اكتشاف</b><span>Radar للأخبار والمصادر</span></div>
